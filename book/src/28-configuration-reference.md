...
| `bnk.trusted_profile.service_account` | string | `f5-cne-controller` | Account allowed to assume the CNE controller's Trusted Profile → `flo_trusted_profile_sa_name`. Env: `ROKSBNKCTL_TRUSTED_PROFILE_SA`. |
